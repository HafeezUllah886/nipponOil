                ...
                <li class="nav-item dropdown user-profile-dropdown  order-lg-0 order-1">
                    ...
                    <div class="dropdown-menu position-absolute" aria-labelledby="userProfileDropdown">
                       ...
                       @can('View Users')
                        ...
                        <div class="dropdown-item">
                            <a href="{{url('/backup')}}">
                               <svg id="Layer_1" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg" stroke="currentColor" data-name="Layer 1"><path d="m24 11.5a4.476 4.476 0 0 0 -1.706-3.5 4.481 4.481 0 0 0 -2.794-8h-15a4.481 4.481 0 0 0 -2.794 8 4.443 4.443 0 0 0 0 7 4.481 4.481 0 0 0 2.794 8h15a4.481 4.481 0 0 0 2.794-8 4.476 4.476 0 0 0 1.706-3.5zm-22-7a2.5 2.5 0 0 1 2.5-2.5h.5v1a1 1 0 0 0 2 0v-1h2v1a1 1 0 0 0 2 0v-1h8.5a2.5 2.5 0 0 1 0 5h-15a2.5 2.5 0 0 1 -2.5-2.5zm20 14a2.5 2.5 0 0 1 -2.5 2.5h-15a2.5 2.5 0 0 1 0-5h.5v1a1 1 0 0 0 2 0v-1h2v1a1 1 0 0 0 2 0v-1h8.5a2.5 2.5 0 0 1 2.5 2.5zm-17.5-4.5a2.5 2.5 0 0 1 0-5h.5v1a1 1 0 0 0 2 0v-1h2v1a1 1 0 0 0 2 0v-1h8.5a2.5 2.5 0 0 1 0 5z"/></svg><span>Database Backups</span>
                            </a>
                        </div>
                        <div class="dropdown-item">
...
/*             menuHTML += '<a href="{{ url("/repair") }}" class="btn btn-dark m-2"> <img src="{{ asset("svgs/repair.svg") }}"> Repair</a>'; */
        ...
        if(name == "accounts"){
           ...
           menuHTML += '<a href="{{ url("/discount") }}" class="btn btn-dark m-2"> <img src="{{ asset("svgs/expense2.svg") }}">Discounts</a>';
        }
        if(name == "purchases"){
        ...
        if(name == "reports"){
            ...
            menuHTML += '<a href="{{ url("/reports/customers") }}" class="btn btn-dark m-2">Customers Summary</a>';
        }
        if(name == "hrm"){
        ...
        if(name == "stock"){
            ...
            menuHTML += '@cannot("Adjust Stocks")<a href="{{ url("/stock_adjustment") }}" class="btn btn-dark m-2"> <img src="{{ asset("svgs/stockAdjustment.svg") }}"> Stock Adjustment</a>@endcannot';
