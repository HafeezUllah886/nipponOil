    ...
    <div class="main" id="main">
          ...
          {{--   <p class="text-center"><strong>{{ $sale->warehouse->phone }}</strong></p>
            ...
            <div class="area-title">
                ...
                <p class="text-center d-flex">
                    ...
                    <p class="text-center bg-dark"><strong> Account Statement </strong></p>
            </div>
            <table width="100%">
                <tr>
                    <td width="">Account Title: </td>
                    <td width="" colspan="2"> {{$account->name}} </td>
                   
                    <td width="">Prev Balance :</td>
                    <td class="text-right"> {{number_format($p_balance,3)}} </td>
                </tr>
                <tr>
                    <td width=""> From: </td>
                    <td width=""> {{date('d M Y', strtotime($from))}} </td>
                    <td width="40%"></td>
                    <td width=""> Cur Balance: </td>
                    <td class="text-right"> {{number_format($c_balance,3)}} </td>
                </tr>
                <tr>
                    <td width=""> To: </td>
                    <td width=""> {{date('d M Y', strtotime($to))}} </td>
                    <td></td>
                    <td width=""> Print Date: </td>
        ...
        <div class="content">
            <table>
                ...
                <td class="text-right">{{ $item->credit == null ? '-' : number_format($item->credit,3)}}</td>
                <td class="text-right">{{ $item->debt == null ? '-' : number_format($item->debt,3)}}</td>
