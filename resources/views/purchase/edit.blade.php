                                ...
                                <table id="myTable" class="table table-hover order-list">
                                    ...
                                    <tbody id="tbody">
                                        ...
                                        <tr id="rowID_{{$id}}">
                                            ...
                                            <td class="no-padding"><input type="number" class="form-control" style="padding-left:0px;padding-right:0px;text-align:center;" step="any" name="discount_{{$id}}" min="0" value="{{$product->discount}}" oninput="changeDiscount(this, {{$id}})"></td>
                                            <td class="no-padding"><input type="number" class="form-control" style="padding-left:0px;padding-right:0px;text-align:center;" step="any" name="tax_{{$id}}" min="0" value="{{$product->tax}}" oninput="changeTax(this, {{$id}})"></td>
