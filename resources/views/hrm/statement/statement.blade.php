...
<div class="col-12">
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h3 class="card-title">
                <i class="fas fa-user-graduate"></i> Employee Statement
            </h3>
            <div class="card-actions">
                <a href="{{ url("/hrm/employees") }}" class="btn btn-dark d-none d-sm-inline-block">
                     Back
                </a>
            </div>
        </div>
                        ...
                        <form id="form">
                            <div class="row">
                                @php
                                    $currentYear = date('Y');
                                    $currentMonth = date('m');
                                    $firstDayOfMonth = date('Y-m-01', strtotime("$currentYear-01-01"));
...
@section('more-script')
    ...
    $.ajax({
    method: "get",
    url: "{{url('/hrm/statement/details/')}}/"+{{$emp->id}}+"/"+from+"/"+to,
